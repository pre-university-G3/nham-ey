...
export default function MentorCard({image,role,name}){
  return (
    <div className="bg-white dark:bg-gray-600 rounded-[15px]  text-center w-[349px] h-[508px] py-[34px] px-[30px]"> 
      ...
      <h3 className="text-[#9796A1] mt-[35px] text-[16px] font-kh dark:text-[#d7d7db]">{role}</h3>
      <h2 className="text-[32px] font-bold font-kh mt-[15px] dark:text-gray-200">{name}</h2>
