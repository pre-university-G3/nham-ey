export default function FoodCard({ image_url, name, description, price, average_rating }) {
  return (
    <>
      <a href="">
        <div className="w-[400px] h-[419px] bg-white rounded-2xl shadow-sm box-border mb-10">
          <div className="relative px-[20px] py-[20px] bg-[#fafaf9]">
            ...
            <button className="absolute top-8 right-8 p-2 rounded-full shadow-md bg-white/20 backdrop-blur-[px]">
              <svg width="24" height="21" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
            </button>
          </div>
          <div className="p-4">
