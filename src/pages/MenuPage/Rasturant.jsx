...
export default function Rasturant() {
  ...
  return (
    <main className="dark:bg-gray-900 dark:text-white">
      {/* Mobile Banner */}
      <section className="block md:hidden w-full py-12 bg-primary dark:bg-gray-800 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/Assets/cambodian-pattern.png')] bg-repeat opacity-20 mix-blend-overlay"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-primary/90 via-primary/70 to-primary/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600"></div>
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-lg text-white/90 font-light">FRESH, FLAVORFUL, AUTHENTIC</p>
        </div>
      </section>
      ...
      <section className="hidden md:block w-full py-16">
        <div className="container mx-auto px-4">
          <div className="relative rounded-3xl overflow-hidden h-[400px] bg-primary dark:bg-gray-800">
            <div className="absolute inset-0 bg-[url('/Assets/cambodian-pattern.png')] bg-repeat opacity-20 mix-blend-overlay"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-primary/90 via-primary/70 to-primary/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600"></div>
      ...
      <div className="text-center my-16">
        <h1 className="text-primary dark:text-yellow-400 text-4xl font-bold mb-4">
          Discover <span className="text-gray-800 dark:text-gray-200">Cambodia's Finest</span>
        </h1>
        <div className="flex justify-center mb-8">
          <div className="w-24 h-1 bg-gradient-to-r from-primary to-gray-300 dark:from-yellow-400 dark:to-gray-600 rounded-full"></div>
        </div>
